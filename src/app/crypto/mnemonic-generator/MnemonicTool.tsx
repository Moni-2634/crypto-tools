...
export default function MnemonicTool() {
  ...
  return (
    <div className="space-y-6">
      {/* Security Warning */}
      <div className="rounded-lg border border-yellow-700 bg-yellow-900/20 px-4 py-3">
      ...
      <div className="border-t border-gray-800 pt-6">
        ...
        <div className="space-y-4">
          ...
          {validationResult === "valid" && (
            <p className="rounded-lg border border-green-800 bg-green-900/30 px-4 py-3 text-sm text-green-400">
