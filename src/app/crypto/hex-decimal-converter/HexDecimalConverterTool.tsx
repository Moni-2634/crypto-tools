    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-700 bg-gray-800 px-4 py-3 text-sm font-mono text-white placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
      ...
      <div className="rounded-lg border border-gray-800 bg-gray-900 p-4">
        ...
        <div className="space-y-1 text-sm text-gray-500">
          ...
          <p>Example: <code className="text-gray-400">0x1e8480</code> = <code className="text-gray-400">2,000,000</code> (gas limit)</p>
        </div>
      </div>
    </div>
  );
