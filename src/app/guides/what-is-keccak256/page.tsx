      ...
      <article className="prose-custom space-y-8">
        ...
        <section className="space-y-4">
          ...
          <ol className="ml-6 list-decimal space-y-2 text-gray-300">
            <li>
              <strong className="text-white">Deterministic</strong>: The same
              input always produces the same output.
            </li>
            <li>
              <strong className="text-white">Pre-image resistant</strong>: Given
              a hash, it is computationally infeasible to find the original
              input.
            </li>
            <li>
              <strong className="text-white">Collision resistant</strong>: It is
              ...
              <tbody className="text-gray-400">
                ...
                <tr className="border-b border-gray-800">
                  ...
                  <td className="px-4 py-3">
                    <code className="rounded bg-gray-800 px-1.5 py-0.5 text-amber-400">
                      0x01
                    </code>
                  </td>
                  <td className="px-4 py-3">
...
SHA-3-256("hello") = 0x3338be694f50c5f338814986cdf0686453a888b84f424d792af4b9202398f392`}</code>
        ...
        <section className="space-y-4">
          ...
          <p className="leading-relaxed text-gray-300">
            ...
            <strong className="text-white">sponge construction</strong>. Unlike
          ...
          <h3 className="text-xl font-semibold text-white">The State</h3>
          <p className="leading-relaxed text-gray-300">
          ...
          <ul className="ml-6 list-disc space-y-2 text-gray-300">
            <li>
              <strong className="text-white">Rate (r)</strong>: 1088 bits
              &mdash; the portion that interacts with input and output
            </li>
            <li>
              <strong className="text-white">Capacity (c)</strong>: 512 bits
...
bytes32 hash = keccak256(abi.encode(addr, amount));`}</code>
          ...
          <ul className="ml-6 list-disc space-y-2 text-gray-300">
            <li>
              <strong className="text-white">abi.encode</strong>: Pads each
              argument to 32 bytes. Unambiguous. Use for hashing structured data.
            </li>
            <li>
              <strong className="text-white">abi.encodePacked</strong>:
...
const hash = '0x' + keccak256(Buffer.from('48656c6c6f', 'hex'));`}</code>
          ...
          <p className="leading-relaxed text-gray-300">Or using ethers.js:</p>
          <pre className="overflow-x-auto rounded-lg bg-gray-800 p-4 text-sm leading-relaxed text-gray-200">
...
const hash = keccak256(toUtf8Bytes('hello'));`}</code>
        ...
        <section className="space-y-4">
          ...
          <ol className="ml-6 list-decimal space-y-2 text-gray-300">
            <li>
              <strong className="text-white">Do not use for passwords</strong>:
            ...
            <li>
              <strong className="text-white">On-chain randomness</strong>:{" "}
              <code className="rounded bg-gray-800 px-1.5 py-0.5 text-sm text-amber-400">
