  ...
  return (
    <ToolLayout slug="bip39-explained">
      ...
      <article className="prose-custom space-y-8">
        ...
        {/* What is BIP39 */}
        <section className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">What is BIP39?</h2>
   ...
   army van deer turn pause ring estate match patrol voyage ring piece`}</code>
        ...
        <section className="space-y-4">
          ...
          <ol className="ml-6 list-decimal space-y-2 text-gray-700 dark:text-gray-300">
            <li>
              <strong className="text-gray-900 dark:text-white">Unique 4-letter prefix</strong>: No
            ...
            <li>
              <strong className="text-gray-900 dark:text-white">Common English words</strong>:
              Words are simple and widely known (e.g., &quot;apple,&quot;
              &quot;river,&quot; &quot;garden&quot;) to reduce transcription
              errors.
            </li>
            <li>
              <strong className="text-gray-900 dark:text-white">No offensive words</strong>:
              Potentially offensive or inappropriate words were excluded.
            </li>
            <li>
              <strong className="text-gray-900 dark:text-white">No similar words</strong>: Words
...
m/44'/501'/0'/0'   \u2192 First Solana address`}</code>
              ...
              <tbody className="text-gray-600 dark:text-gray-400">
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  <td className="px-4 py-3">
                    <code className="text-amber-600 dark:text-amber-400">m</code>
                  </td>
                ...
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  <td className="px-4 py-3">
                    <code className="text-amber-600 dark:text-amber-400">44&apos;</code>
                  </td>
                ...
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  <td className="px-4 py-3">
                    <code className="text-amber-600 dark:text-amber-400">coin_type&apos;</code>
                  </td>
                ...
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  <td className="px-4 py-3">
                    <code className="text-amber-600 dark:text-amber-400">account&apos;</code>
                  </td>
                ...
                <tr className="border-b border-gray-200 dark:border-gray-800">
                  <td className="px-4 py-3">
                    <code className="text-amber-600 dark:text-amber-400">change</code>
                  </td>
                  <td className="px-4 py-3">
                ...
                <tr>
                  <td className="px-4 py-3">
                    <code className="text-amber-600 dark:text-amber-400">address_index</code>
                  </td>
        ...
        <section className="space-y-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Entropy Quality</h3>
          <p className="leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          <ol className="ml-6 list-decimal space-y-2 text-gray-700 dark:text-gray-300">
            <li>
              <strong className="text-gray-900 dark:text-white">Write on paper or metal</strong>:
            ...
            <li>
              <strong className="text-gray-900 dark:text-white">Never share</strong>: No legitimate
              service will ever ask for your mnemonic phrase. Anyone who has your
              phrase has full control of your funds.
            </li>
            <li>
              <strong className="text-gray-900 dark:text-white">Consider metal backup</strong>:
